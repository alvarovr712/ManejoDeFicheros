...
public class GestionDelAlmacen {
    ...
    private void exportarDatos() {
        File fileCSV = new File("src/main/java/resources/coches.csv");
        try (PrintWriter printWriter = new PrintWriter(fileCSV)) {
            ...
            System.out.println("Error: no se pudo crear el archivo CSV");
        }
    }
}
